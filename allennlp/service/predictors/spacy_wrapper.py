...
class spacy_wrapper:
    ...
    def chunk_by_filters(self, head_filter, child_filter):
        ...
        for head, (chunk, chunkLemma) in consecutive_chunks.items():
    ...
    def is_obj(self, ind):
        ...
        return ('obj' in rel) or ('attr' in rel) or ('adv' in rel)
...
def consecutive(span):
    ...
    """
    return [i - span[0] for i in span] == list(range(span[-1] - span[0] + 1))
